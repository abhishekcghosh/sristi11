<?php
	...
	define("__SQL_TABLE_PREFIX__","sristi11_",true);						//MySQL Table name prefix for the site db
	
	//Site Specification CONSTANTS
	define("__SITE_ADMINEMAIL__","sristi.cfi@gmail.com",true);			//Site Admin's Email Address, (internal, dev work) where error-reports, feedback etc. will go
